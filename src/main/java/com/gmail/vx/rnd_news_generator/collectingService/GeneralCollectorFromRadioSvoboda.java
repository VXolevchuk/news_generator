...
@Component
public class GeneralCollectorFromRadioSvoboda {
    private final Source source = new Source("Radio Svoboda");
    @Autowired
    private SourceService sourceService;
    @Autowired
    private SubjectCollectorFromRadioSvoboda subjectCollector;
    @Autowired

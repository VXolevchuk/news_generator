...
@Component
public class GeneralCollectorFromUkrPravda {
    @Autowired
    private SourceService sourceService;

    //private final String  sourceName = "Ukrainska Pravda";
    private final Source source = new Source("Ukrainska Pravda");

    @Autowired
    private SubjectCollectorFromUkrPravda subjectCollector;
    @Autowired
